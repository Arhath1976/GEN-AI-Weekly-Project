...
def dialog_experimental_notice():
    st.markdown("This is an experimental project. Some bugs may appear.")
...
def dialog_analysing():
    st.markdown("Please wait while your documents are being processed.")
    ...
    try:
        ...
        status.caption("Calling Ollama embeddings…")
